<html>
<head>
<title>View Diamond Certificate Summary</title>
...
<link rel="stylesheet" type="text/css" href="css/certsummary.css" />
</head>
<body>
<?php
//include("login.php"); 
...
//		$caratweight=mysql_result($result,0,"caratweight");
		...
		*/
		...
		<div class="forref">for reference only</div>
		<div class="reportcheck">DEL Report Check</div>
		<div class="reportnum">DEL REPORT NUMBER: <?php echo $certid; ?></div>
		<br/><br/>
		<table>
			<tr>
				<td colspan="2" class="cattitle"><?php echo $shape; ?></td>
			</tr>
			<tr class="rowstyle">
				<td class="fieldcol">Measurements:</td>
				<td><?php echo $full_measure; ?></td>
			</tr>
			<tr>
				<td>Carat Weight:</td>
				<td><?php echo $full_caratweight; ?></td>
			</tr>
			<tr>
				<td>Color Grade:</td>
				<td><?php echo $colorgrade; ?></td>
			</tr>
			<tr>
				<td>Clarity Grade:</td>
				<td><?php echo $claritygrade; ?></td>
			</tr>
			<tr>
				<td>Cut Grade:</td>
				<td><?php echo $cutgrade; ?></td>
			</tr>
			<tr>
				<td colspan="2" class="cattitle">Proportions:</td>
			</tr>
			<tr>
				<td>Depth: </td>
			...
			<tr>
				<td>Table:</td>
				<td><?php echo "$tablesurface%"; ?></td>
			</tr>
			<tr>
				<td>Gridle thickness:</td>
				<td><?php echo $gridlethickness; ?></td>
			</tr>
			<tr>
				<td colspan="2" class="cattitle">Finish:</td>
			</tr>
			<tr>
				<td>Polish:</td>
			...
			<tr>
				<td>Symmetry:</td>
				<td><?php echo $symmetry; ?></td>
			</tr>
			<tr>
				<td>Fluorescence:</td>
				<td><?php echo $fluorescence; ?></td>
			</tr>
			<tr>
				<td>Comments:</td>
